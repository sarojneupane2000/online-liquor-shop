...
<?php 
    //CHeck whether raksi id is set or not
    if(isset($_GET['raksi_id']))
    {
        //Get the raksi id and details of the selected raksi
        $raksi_id = $_GET['raksi_id'];

        //Get the DEtails of the SElected raksi
        $sql = "SELECT * FROM tbl_raksi WHERE id=$raksi_id";
        //Execute the Query
        ...
        <form action="" method="POST" class="order">
            <fieldset>
                ...
                <div class="raksi-menu-desc">
                    ...
                    <input type="hidden" name="raksi" value="<?php echo $title; ?>">
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                if($res2==true)
                {
                    ...
                    $_SESSION['order'] = "<div class='success text-center'>raksi Ordered Successfully.</div>";
                    header('location:'.SITEURL);
                }
                else
                {
                    //Failed to Save Order
                    $_SESSION['order'] = "<div class='error text-center'>Failed to Order raksi.</div>";
                    header('location:'.SITEURL);
                }
